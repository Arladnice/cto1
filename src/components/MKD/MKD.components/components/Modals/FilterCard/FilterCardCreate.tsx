...
import { IconBucket, IconCheck16, IconCross, IconCross16, IconPlus } from '@/components/MKD/components/Icons.tsx';
...
import { useStoreFilterCardCreate } from '@/components/MKD/stores/stores.ts';
...
const FilterCardCreate = ({ onHide }: FilterCardParams) => {
    const [filterName, setFilterName] = useState('');
    const [srcData, setSrcData] = useState('');
    const [rule, setRule] = useState('');
    const [rangeMin, setRangeMin] = useState<string | null>(null);
    const [rangeMax, setRangeMax] = useState<string | null>(null);
                ...
                <div className='flex h-[697px] w-full flex-col gap-9 text-xs'>
                        ...
                        <div className='flex h-11 flex-row gap-5'>
                            ...
                            <div className='flex w-full gap-5'>
                                <InputModalTextField
                                    ...
                                    className={srcData !== 'Ручной ввод' ? 'invisible' : ''}
                                />
                                <InputModalTextField
                                    value={rangeMax}
                    ...
                    <div className='flex h-[564px] w-full flex-col gap-2.5'>
                        <div className='h-3.5 w-full content-center text-center text-xs text-[#002033]'>
                            ВЫБОР ПАРАМЕТРОВ ДЛЯ НОВОГО ФИЛЬТРА
                        </div>
...
export default FilterCardCreate;
